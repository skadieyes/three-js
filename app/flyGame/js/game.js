...
var Pilot = function () {
    ...
    var bodyGeom = new THREE.SphereGeometry(15, 15, 15);
    var bodyMat = new THREE.MeshPhongMaterial({
        color: 0xffffff,
        shading: THREE.FlatShading
    });
    var body = new THREE.Mesh(bodyGeom, bodyMat);
    body.position.set(2, -6, 2);
    ...
    face.position.set(2, 2, 2);
    this.mesh.add(face);

    var hairGeom = new THREE.BoxGeometry(6, 6, 6);
...
Ennemy = function () {
    var geom = new THREE.TorusKnotGeometry(8, 0.87, 178, 6, 3, 5, 2.5);
    var mat = new THREE.MeshPhongMaterial({
        color: Colors.red,
        shininess: 0,
        specular: 0xffffff,
